## level0 - Buffer Overflow

---
### Steps to solve
- #### Use gdb to get the disassembly of functions and tracking instructions.
    ...
    - #### Assembly code of main function.
        ```c
            ...
            0x08048f86 <+198>:   ret
        ```
        #### First we can see that there is call of atoi function to convert `argv[1]` to number.
        ```c
            0x08048ec6 <+6>:     sub    $0x20,%esp
        ...
        ```c
            ...
            0x08048ede <+30>:    jne    0x8048f58 <main+152> // if not equal jmp to (0x8048f58) else continue
            0x08048ee0 <+32>:    movl   $0x80c5348,(%esp)
            0x08048ee7 <+39>:    call   0x8050bf0 <strdup>
        ```
        ...
        ```c
            0x08048f46 <+134>:   mov    %eax,0x4(%esp)
            0x08048f4a <+138>:   movl   $0x80c5348,(%esp) // push the parameter of execv
            0x08048f51 <+145>:   call   0x8054640 <execv>
        ```
